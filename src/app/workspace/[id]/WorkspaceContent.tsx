...
function useProofMessagesFromIntl(): ProofMessages {
  ...
  return useMemo(
    (): ProofMessages => ({
      ...
      simplifyFormula: t("simplifyFormula"),
      simplifyFormulaApplied: t("simplifyFormulaApplied"),
      simplifyFormulaNoChange: t("simplifyFormulaNoChange"),
      simplifyFormulaParseError: t("simplifyFormulaParseError"),
      simplifyFormulaEmpty: t("simplifyFormulaEmpty"),
