...
- [ ] スクリプトエディタのテンプレートは、より強くしよう
  ...
  - [x] スクリプトライブラリから開く、のような方法にして、検索したりしながら探せるように — scriptLibraryLogic.ts(純粋検索/フィルタ) + ScriptLibraryPanel.tsx(UI) + ScriptEditorComponent.tsx統合。ビルトイン+保存済みを統合表示、テキスト検索+種類フィルタ
  - [ ] ライブラリの充実
